...
class CodigosCargosDescuentos extends Catalogo{
  ...
  /**
   * Obtener indicador que determina si es un cargo de detalle
   * @return {Boolean}
   */
  esCargoDet() {
    const esCargoDet = (
      this.indicador() === true && this.nivel() === 'item'
    );
  ...
  /**
   * Obtener indicador que determina si es un descuento de detalle
   * @return {Boolean}
   */
  esDescuentoDet() {
    const esDescuentoDet = (
      this.indicador() === false && this.nivel() === 'item'
    );

    return esDescuentoDet;
  }

  /**
   * Obtener indicador que determina si es un cargo global
   * @return {Boolean}
   */
  esCargoGlb() {
    const esCargoGlb = (
      this.indicador() === true && this.nivel() === 'global'
    );
  ...
  /**
   * Obtener indicador que determina si es un descuento global
   * @return {Boolean}
   */
  esDescuentoGlb() {
    const esDescuentoGlb = (
      this.indicador() === false && this.nivel() === 'global'
    );

    return esDescuentoGlb;
  }
}
